    ...
    <v-row>
      ...
      <v-col cols="12" md="5">
        <v-card variant="flat" border class="rounded-xl pa-6 sticky-card" style="height: 100%;">
          ...
          <v-text-field v-model.number="calcPrice" label="아이템 가격 (Gold)" variant="outlined" prefix="💰" type="number"
            color="secondary" class="text-h5 mb-2" hide-details></v-text-field>
          ...
          <v-sheet v-else color="grey-lighten-4" border rounded="lg"
