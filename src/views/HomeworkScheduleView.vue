            ...
            <div class="text-caption text-medium-emphasis font-weight-bold d-flex align-center flex-wrap gap-2">
              ...
              <v-tooltip location="bottom" offset="10" transition="fade-transition">
                ...
                <v-card variant="flat" color="grey-darken-4" class="pa-3 rounded-lg border">
                  <div class="text-subtitle-2 font-weight-black mb-2 text-grey-lighten-1">
                    💰 주간 수익 상세 내역
                  </div>
                  ...
                  <div class="d-flex flex-column gap-2" style="min-width: 180px">
                    ...
                    <div class="d-flex justify-space-between align-center">
                      ...
                      <span class="text-red-accent-2 font-weight-bold num-style">-{{ getTotalMoreCost().toLocaleString()
                        }}G</span>
                    </div>
                  </div>
                </v-card>
              ...
              <v-chip size="x-small" :color="getMaxPossibleGold() - getTotalGrossGold() > 0
                ...
                {{
                  getMaxPossibleGold() - getTotalGrossGold() > 0
                    ? "남은 수익: " +
                    (
                      getMaxPossibleGold() - getTotalGrossGold()
                    ).toLocaleString() +
                    "G"
                    : "주간 수입 목표 완료"
                }}
                ...
                <v-list-item class="pa-3 bg-profile-header" :subtitle="`Lv. ${char.level} ${char.className}`">
                  ...
                  <template v-slot:append>
                    <div class="d-flex align-center">
                      ...
                      <v-fade-transition>
                        <v-btn v-if="isHovering" icon="mdi-delete-outline" variant="text" color="error" size="small"
                        ...
                        <div v-if="isTaskVisible(char, task.id)" class="task-container">
                          <div class="d-flex align-center justify-space-between mb-1">
                            <v-checkbox v-model="char.completedTasks" :value="task.id" :label="task.name" hide-details
                              density="compact" color="orange" @change="saveToLocal"
                                  ...
                                  <template v-slot:label>
                                    <div class="d-flex align-center">
                                      ...
                                      <span class="text-overline font-weight-black">
                                        {{ gate.g }} 관문
                                        <span class="ms-1 num-style" style="
                                            font-size: 0.6rem;
                                            opacity: 0.7;
                                          ">({{
                                            (gate.gold / 1000).toFixed(1)
                                          }}k{{
                                            raid.name.includes("싱글")
                                              ? " 귀속"
                                              : ""
                                          }})</span>
                                      </span>
